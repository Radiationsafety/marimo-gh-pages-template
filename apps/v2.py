...
def _(mo):
    ...
    return reading_inputs, ui_display
...
@app.cell
def _(reading_inputs):
    # Читаем текущие значения - создает реактивную зависимость!
    current_readings = {k: v.value for k, v in reading_inputs.items()}
    print(current_readings)
    return (current_readings,)


@app.cell
def _(current_readings, detector, go, iterations, reg_power):
